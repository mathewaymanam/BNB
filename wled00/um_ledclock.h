...
public:
    ...
    void setup() {
        ...
        dHoursT.mapSegment(_7SEG_SEG_A, 2, 3);
        dHoursT.mapSegment(_7SEG_SEG_B, 4, 5);
        dHoursT.mapSegment(_7SEG_SEG_C, 6, 7);
        dHoursT.mapSegment(_7SEG_SEG_D, 8, 9);
        dHoursT.mapSegment(_7SEG_SEG_E, 10, 11);
        dHoursT.mapSegment(_7SEG_SEG_F, 0, 1);
        dHoursT.mapSegment(_7SEG_SEG_G, 12, 13);

        // digit 2
        dHoursO.mapSegment(_7SEG_SEG_A, 16, 17);
        dHoursO.mapSegment(_7SEG_SEG_B, 18, 19);
        dHoursO.mapSegment(_7SEG_SEG_C, 20, 21);
        dHoursO.mapSegment(_7SEG_SEG_D, 22, 23);
        dHoursO.mapSegment(_7SEG_SEG_E, 24, 25);
        dHoursO.mapSegment(_7SEG_SEG_F, 14, 15);
        dHoursO.mapSegment(_7SEG_SEG_G, 26, 27);
        ...
        // digit 3
        dMinutesT.mapSegment(_7SEG_SEG_A, 32, 33);
        dMinutesT.mapSegment(_7SEG_SEG_B, 34, 35);
        dMinutesT.mapSegment(_7SEG_SEG_C, 36, 37);
        dMinutesT.mapSegment(_7SEG_SEG_D, 38, 39);
        dMinutesT.mapSegment(_7SEG_SEG_E, 40, 41);
        dMinutesT.mapSegment(_7SEG_SEG_F, 30, 31);
        dMinutesT.mapSegment(_7SEG_SEG_G, 41, 43);

        // digit 4
        dMinutesO.mapSegment(_7SEG_SEG_A, 46, 47);
        dMinutesO.mapSegment(_7SEG_SEG_B, 48, 49);
        dMinutesO.mapSegment(_7SEG_SEG_C, 50, 51);
        dMinutesO.mapSegment(_7SEG_SEG_D, 52, 53);
        dMinutesO.mapSegment(_7SEG_SEG_E, 54, 55);
        dMinutesO.mapSegment(_7SEG_SEG_F, 44, 45);
        dMinutesO.mapSegment(_7SEG_SEG_G, 56, 47);
